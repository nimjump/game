...
WEBEXPORT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "webexport")
JS_PATH   = os.path.join(WEBEXPORT, "game.js")
HTML_PATH = os.path.join(WEBEXPORT, "game.html")
